...
<figure id="fig:roadmap" data-latex-placement="ht">
<img src="../figures/roadmap_figure.png" />
<figcaption><strong>From the spectral action to all of physics.</strong> The four-level spectral cascade from the axiom (<span class="math inline"><em>S</em><sup>5</sup>/ℤ<sub>3</sub></span> and its five invariants) through <span class="math inline"><em>m</em><sub><em>e</em></sub></span> (unit), <span class="math inline"><em>m</em><sub><em>p</em></sub> = 6<em>π</em><sup>5</sup><em>m</em><sub><em>e</em></sub></span> (QCD scale), <span class="math inline">1/<em>α</em> = 137.038</span> (EM coupling), and <span class="math inline"><em>v</em>, <em>m</em><sub><em>H</em></sub></span> (EW scale) to all 43 predictions. Every arrow is an explicit derivation in Supplement X. All 43 predictions are at Theorem level.</figcaption>
</figure>
...
3.  All twenty-six predictions use the same manifold, the same five spectral invariants (Table [1](#tab:invariants){reference-type="ref" reference="tab:invariants"}), and zero additional parameters.
...
The Supplements I--XII provide a complete provenance map applying these labels to every result. Supplement XI is the derivation status firewall (for every claim: status, proof location, script, skeptic's objection, and response). Supplement XII is the companion guide (topic-based reference: hurricanes, equations, LOTUS, predictions, strange castles).
...
- **Derived:** Structural decomposition identified but full spectral action integral not yet computed. As of v10, this category is **empty**: all formerly Derived claims have been promoted to Theorem through explicit spectral action chains (Supplement X).
...
<figcaption>The five spectral invariants of <span class="math inline"><em>S</em><sup>5</sup>/ℤ<sub>3</sub></span> mapped to the geometry: <span class="math inline"><em>d</em><sub>1</sub> = 6</span> ghost modes on the fold walls, first eigenvalue <span class="math inline"><em>λ</em><sub>1</sub> = 5</span> (dashed ring), Koide simplex <span class="math inline"><em>K</em> = 2/3</span> (inscribed triangle), eta invariant <span class="math inline"><em>η</em> = 2/9</span> (fold wall width), and orbifold order <span class="math inline"><em>p</em> = 3</span> (three sectors). Every formula in this paper — all 43 predictions — traces back to these five numbers.</figcaption>
</figure>
...
::: parambox
P1: Koide ratio **Formula:** $K = 2/3$ **Predicted:** $0.666\overline{6}$ (exact) **Measured:** $0.666661\pm 0.000007$ **Precision:** Exact
...
::::: parambox
P2: Koide phase **Formula:** $\delta = 2\pi/3 + 2/9$ **Predicted:** $2.3416$ rad **Measured:** --- **Precision:** Derived
...
This promotes $N = 1$ from *Derived* to *Theorem*: the commutativity $[f(D/\Lambda), e_m] = 0$ eliminates the cutoff-function ambiguity that was the only remaining gap. Full proof: Supplement II, §4.

Full derivation: Supplement II, §§1--4. Connection to Chamseddine--Connes spectral action: Supplement II, §5.
:::::

::: parambox
P3: Generation count **Formula:** $N_g = 3$ **Predicted:** $3$ (exact) **Measured:** $3$ **Precision:** Exact
...
::: parambox
P4: Muon-to-electron mass ratio **Formula:** $m_\mu/m_e$ **Predicted:** $206.768$ ($m_\mu = 105.6594$ MeV) **Measured:** $105.6584\pm 0.0001$ MeV **Precision:** $0.001\%$
...
::: parambox
P5: Tau-to-electron mass ratio **Formula:** $m_\tau/m_e$ **Predicted:** $3477.2$ ($m_\tau = 1776.985$ MeV) **Measured:** $1776.86\pm 0.12$ MeV **Precision:** $0.007\%$
...
::: parambox
P6: Strong CP angle **Formula:** $\bar\theta_{\mathrm{QCD}} = 0$ **Predicted:** $0$ (exact) **Measured:** $|\bar\theta| < 10^{-10}$ **Precision:** Exact
...
::: parambox
P7: Electron mass **Formula:** $m_e = 0.51100\text{ MeV}$ **Predicted:** --- **Measured:** $0.51100$ MeV **Precision:** Unit
...
::: parambox
P8: Electroweak mixing angle **Formula:** $\sin^2\theta_W = 3/8$ **Predicted:** $0.2313$ (at $M_Z$) **Measured:** $0.23122\pm 0.00003$ **Precision:** $0.05\%$ (at $M_Z$)
...
::: parambox
P9: Strong coupling constant **Formula:** $\alpha_s(M_Z) = 0.1187$ **Predicted:** $0.1187$ **Measured:** $0.1180\pm 0.0009$ **Precision:** $0.56\%$ from PDG
...
:::: parambox
P10: Color group from isometry **Formula:** $\mathrm{SU}(3)_C \subset \mathrm{Isom}(S^5/\mathbb{Z}_3)$ **Predicted:** --- **Measured:** --- **Precision:** Structural
...
::: parambox
P11: Proton-to-electron mass ratio **Formula:** $m_p/m_e = 6\pi^5$ **Predicted:** $1836.118$ (leading) **Measured:** $1836.15267343(11)$ **Precision:** $0.002\%$ (leading)
...
6.  Ghost modes carry color $\mathbf{3}\oplus\bar{\mathbf{3}}$ and are confined (*Derived*: from T2 + isometry structure).
...
Steps T1--T5 are theorems with no free parameters. Step P1 is derived from the spectral exclusion. Step P2 is the physical identification --- it is *falsifiable*: if $6\pi^5$ did not approximate $m_p/m_e$, the identification would fail. The $10^{-11}$ two-loop agreement (P12) constitutes a $5$-decimal-place verification that P2 is correct. Leptons ask *where* on the Koide circle ($\delta$); the proton asks *how much* the circle weighs ($6\pi^5$). Same six modes, two orthogonal readouts. Full derivation: Supplement IV, §§2--3.
:::

::: parambox
P12: Spectral radiative corrections **Formula:** $G = 10/9,\; G_2 = -280/9$ **Predicted:** see below **Measured:** see below **Precision:** $10^{-8}$ (1-loop); $10^{-11}$ (2-loop)
...
::: parambox
P13: Fine-structure constant **Formula:** $1/\alpha_{\mathrm{GUT}} + G/p \;\xrightarrow{\text{RG}}\; 1/\alpha(0) = 137.038$ **Predicted:** $137.038$ **Measured:** $137.036$ **Precision:** $0.001\%$ (geometric)
...
\end{equation}$$ where $G/p = \lambda_1\eta/p = 10/27$ is the proton spectral coupling $G = 10/9$ distributed across $p = 3$ sectors. SM RG running from $M_c$ to $\alpha(0)$ then gives $1/\alpha(0) = 137.038$ ($0.001\%$ from CODATA).
...
:::: parambox
P14: Higgs VEV **Formula:** $\displaystyle\frac{v}{m_p} = \frac{2}{\alpha} - \frac{35}{3}$ **Predicted:** $v = 246.24$ GeV ($v/m_p = 262.405$) **Measured:** $v/m_p = 262.418$ **Precision:** $0.005\%$

The six $\ell=1$ ghost modes carry non-trivial $\mathbb{Z}_3$ charge: $\chi(g|\ell{=}1) = 3\omega + 3\omega^2 = -3$. The twisted sector weight is $W_{\mathrm{tw}} = (-3-3)/3 = -2$. The missing spectral capacity $|W_{\mathrm{tw}}| = 2$, in electromagnetic coupling units ($1/\alpha(0)$), gives total EM budget $2/\alpha$. This budget splits between the physical Higgs VEV (overlap amplitude between $\mathbb{Z}_3$ sectors) and the ghost spectral footprint, which collects three layers of data: $$\begin{equation}
...
:::: parambox
P15: Higgs boson mass **Formula:** $\displaystyle\frac{m_H}{m_p} = \frac{1}{\alpha} - \frac{7}{2}$ **Predicted:** $m_H/m_p = 133.536$ ($m_H = 125.29$ GeV) **Measured:** $m_H/m_p = 133.490$ **Precision:** $0.034\%$
...
::: parambox
P16: Higgs quartic coupling **Formula:** $\lambda_H = \frac{(1/\alpha - 7/2)^2}{2(2/\alpha - 35/3)^2}$ **Predicted:** $0.1295$ **Measured:** $0.1294$ **Precision:** $0.07\%$
...
::: parambox
P17: Cabibbo angle **Formula:** $\lambda_{\mathrm{bare}} = 2/9;\;\; \lambda_{\mathrm{phys}} = \tfrac{2}{9}(1 + \tfrac{\alpha_s}{3\pi})$ **Predicted:** $0.22500$ **Measured:** $0.2250\pm 0.0007$ **Precision:** $0.002\%$ (corrected)
...
::: parambox
P18: Wolfenstein $A$ **Formula:** $A_{\mathrm{bare}} = 5/6;\;\; A_{\mathrm{phys}} = \tfrac{5}{6}(1 - \tfrac{2}{9}\tfrac{\alpha_s}{\pi})$ **Predicted:** $0.8264$ **Measured:** $0.826\pm 0.012$ **Precision:** $0.046\%$ (corrected)
...
::: parambox
P19: CP-violating parameters **Formula:** $\bar\rho = 1/(2\pi),\;\; \bar\eta = \pi/9$ **Predicted:** see below **Measured:** see below **Precision:** $\bar\rho$: $0.03\%$; $\bar\eta$: $0.02\%$
...
::: parambox
P20: Top quark Yukawa **Formula:** $y_t = 1$ **Predicted:** $m_t = 174.1$ GeV (UV) **Measured:** $m_t = 172.69$ GeV (pole) **Precision:** $0.8\%$ (bare)
...
::: parambox
P21: Reactor angle **Formula:** $\sin^2\theta_{13} = (\eta\, K)^2 = 16/729$ **Predicted:** $0.02194$ **Measured:** $0.02200\pm 0.00069$ **Precision:** $0.24\%$
...
::: parambox
P22: Solar angle **Formula:** $\sin^2\theta_{12} = p/\pi^2 = 3/\pi^2$ **Predicted:** $0.3040$ **Measured:** $0.307\pm 0.013$ **Precision:** $1.0\%$($0.2\sigma$)
...
::: parambox
P23: Atmospheric angle **Formula:** $\sin^2\theta_{23} = d_1/(d_1 + \lambda_1) = 6/11$ **Predicted:** $0.5455$ **Measured:** $0.546\pm 0.021$ **Precision:** $0.10\%$
...
::: parambox
P24: Leptonic CP phase **Formula:** $\delta_{\mathrm{CP}}^{\mathrm{PMNS}} = 3\arctan(2\pi^2/9)$ **Predicted:** $196.5^\circ$ **Measured:** $195^\circ\pm 50^\circ$ **Precision:** ${\sim}0.3\%$ from central value
...
::: parambox
P25: Heaviest neutrino mass **Formula:** $m_3 = m_e/(108\pi^{10}) = m_e^3/(p\,m_p^2)$ **Predicted:** $50.52$ meV **Measured:** $50.28$ meV **Precision:** $0.48\%$
...
::: parambox
P26: Mass-squared ratio **Formula:** $\Delta m^2_{32}/\Delta m^2_{21} = d_1^2 - p = 33$ **Predicted:** $33$ **Measured:** $32.58\pm 0.8$ **Precision:** $1.3\%$
...
<figure id="fig:lotus" data-latex-placement="ht">
<img src="../figures/lotus_potential_figure.png" style="width:95.0%" />
...
- The cosmological constant is nonzero because $\phi < 1$ (lotus breathing: $\Lambda^{1/4} = m_{\nu_3}\eta^2(1 - K/d_1) = m_{\nu_3} \cdot 32/729 = 2.22$ meV, $1.4\%$ from observed; the correction $1 - K/d_1 = 1 - 1/p^2 = 8/9$ is the Koide-phase residual per ghost mode).
...
**Derivation status.** The KK formula [\[eq:kk-gravity\]](#eq:kk-gravity){reference-type="eqref" reference="eq:kk-gravity"} is a standard result of higher-dimensional gravity (Witten [@witten1981]). The bare formula [\[eq:x-bare\]](#eq:x-bare){reference-type="eqref" reference="eq:x-bare"} uses the heat kernel coefficient $a_2$ on $S^5/\mathbb{Z}_3$ (Supplement I). The hurricane coefficient $c_{\mathrm{grav}} = -\tau_R/G = -1/(d_1\lambda_1) = -1/30$ is proven as an algebraic identity (§[12](#sec:gravity){reference-type="ref" reference="sec:gravity"}, equations [\[eq:tau-pn\]](#eq:tau-pn){reference-type="eqref" reference="eq:tau-pn"}--[\[eq:cgrav-tau-G\]](#eq:cgrav-tau-G){reference-type="eqref" reference="eq:cgrav-tau-G"}).
...
2.  **One-loop from twisted sectors.** $Z = \tfrac{1}{3}(Z_e + Z_\omega + Z_{\omega^2})$; the untwisted sector is absorbed by renormalization. *\[Derived.\]*
...
**Why the CC is small.** (a) Heavy modes cancel (equidistribution). (b) Only the neutrino survives ($50$ meV, not $100$ GeV). (c) Double boundary crossing suppresses by $\eta^2 = 4/81$. (d) Koide absorption reduces by $8/9$. Combined: $50 \times 0.044 = 2.2$ meV. Not fine-tuning --- geometry.

Full derivation: Supplement IX, S5; numerical verification: `cc_aps_proof.py`.
...
: **The Master Table.** Forty-three predictions from the spectral geometry of $S^5/\mathbb{Z}_3$ with zero free parameters ($m_e$ is the unit [@duff2002]). All forty-three at Theorem level. **Type:** Boundary = topological invariant (rational); Bulk = metric invariant (involves $\pi$); Complex = complex structure at cone point.
:::

<figure id="fig:scatter" data-latex-placement="ht">
<img src="../figures/prediction_scatter.png" />
<figcaption><strong>All predictions vs measurement.</strong> Each point is a dimensionless prediction from the spectral geometry of <span class="math inline"><em>S</em><sup>5</sup>/ℤ<sub>3</sub></span>. Blue diamonds: Theorem level (19). Red circles: Derived level (20). Green band: <span class="math inline"> &lt; 0.1%</span> error. Yellow band: <span class="math inline"> &lt; 1%</span> error. The largest outliers are cosmological (baryogenesis <span class="math inline">3%</span>, CC <span class="math inline">1.4%</span>), well within their experimental uncertainties. No other framework has a comparable plot.</figcaption>
</figure>
...
5.  **"Black holes have singularities."** The LOTUS potential $V(\phi)$ has finite maximum energy density $\rho_{\max} \sim M_c^4 \ll M_P^4$ (ratio $\sim 10^{-25}$). The ghost spectral pressure ($1/(d_1\lambda_1) = 1/30$ per mode) creates a bounce. No infinite densities. Information preserved by topological $\mathbb{Z}_3$ characters (§[17](#sec:qg){reference-type="ref" reference="sec:qg"}).

## Relation to theory-of-everything criteria

The community checklist for a serious ToE candidate includes ten criteria. Table [11](#tab:toe){reference-type="ref" reference="tab:toe"} summarizes the status of this framework against each, and compares to major contenders.
...
<figure id="fig:emblem" data-latex-placement="h">
<p><img src="../figures/lotus_emblem.png" style="width:75.0%" alt="image" /> <span id="fig:emblem" data-label="fig:emblem"></span></p>
</figure>

[^1]: Only dimensionless ratios are physically meaningful [@duff2002]. The electron mass $m_e$ is the ruler, not a knob: changing it rescales all predictions in lockstep without improving or degrading any fit. The framework has zero free parameters in the sense of Duff, Okun, and Veneziano [@duff2002]: every dimensionless ratio is fixed by the geometry.

[^2]: Computational assistants were used for code verification and algebraic cross-checks.
