...
class Config:
    ...
    def __init__(self):
        ...
        self.content_subdirs = ("math-papers",)

        # Format-based directory layout (relative to public-release root)
        self.tex_dir = "papers"
        self.markdown_dir = "papers/markdown"
        self.pdf_dir = "papers/pdf"
