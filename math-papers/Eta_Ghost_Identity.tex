...
Specifically, we prove that the total spectral asymmetry
...
\begin{align}
\eta_D(\chi_1) &= \frac{i}{9}, \label{eq:eta1}\\
\eta_D(\chi_2) &= -\frac{i}{9}. \label{eq:eta2}
\end{align}
\end{proposition}
...
%% ============================================================
\section{The Torsion--Koide Factorization of $\eta^2$}
...
%% ============================================================
\section{Uniqueness of $L(3;1,1,1)$ Among Lens Spaces}
...
\midrule
Eta invariant & $\eta_D(\chi_1) = +1/9$, $\eta_D(\chi_2) = -1/9$ & $\pm 1/9$ & Theorem (Donnelly) \\
