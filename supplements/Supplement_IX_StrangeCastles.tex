...
\subsection{S15. Baryon asymmetry (Grade A)}
...
Verification: \texttt{alpha\_lag\_proof.py}, \texttt{sm\_completeness\_audit.py}.
...
(iv)~the tunneling bandwidth of the orbifold lattice.
Four independent appearances of one spectral integer from one geometry.
\end{description}
