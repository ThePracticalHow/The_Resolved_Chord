...
lambda_H = 0.1295
m_e = 5.10999e-4        # GeV, electron mass
m_p = m_e * 6 * PI**5  # GeV, proton mass from LENG: m_p/m_e = 6π⁵
v_max = 2 * m_p / alpha  # GeV (2*m_p/alpha)
...
ax.annotate('$\\phi = 0$\nSmooth $S^5$\nNo physics',
            xy=(0, V_norm[0]), xytext=(0.06, 0.80),
...
ax.annotate(f'Barrier $= V(0)^{{1/4}} \\approx 104$ GeV',
            xy=(0.02, V_barrier * 0.9), xytext=(0.22, 0.95),
