...
fig, ax = plt.subplots(figsize=(9, 9.5), facecolor=BG)
ax.set_xlim(-4.5, 4.5)
ax.set_ylim(-4.5, 5.5)
ax.set_aspect('equal')
ax.axis('off')
...
incircle_R = simplex_R * 0.40  # Inscribed circle proportional (< inradius to avoid overlap)
...
# Draw a thin dashed radius line for r=√2 label
ax.plot([0, incircle_R], [0, 0], color=GREEN, linewidth=0.8,
        linestyle=':', alpha=0.5, zorder=5)
ax.text(incircle_R + 0.4, -0.25, r'$r = \sqrt{2}$', fontsize=11,
