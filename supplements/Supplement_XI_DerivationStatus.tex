...
have been promoted to Derived or Theorem.
\end{description}
...
\begin{enumerate}
\item \textbf{Gravity bare formula:} \emph{Completed v10.} Derived via 5-lock proof (Lichnerowicz, curvature, Rayleigh--Bessel). See \texttt{gravity\_theorem\_proof.py}.
