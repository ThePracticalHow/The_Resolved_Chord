...
print()
print("  STATUS: THEOREM (Schur orthogonality closure, see cc_monogamy_proof.py)")
...
print("  2. V_1-loop from twisted sector   [THEOREM: Z_3 partition function]")
print("  3. Neutrino dominates (monogamy)  [THEOREM: Schur orthogonality]")
...
print()
print("  THEOREM (structural decomposition found):")
...
print()
print("  THEOREM (proved by Schur orthogonality in cc_monogamy_proof.py):")
