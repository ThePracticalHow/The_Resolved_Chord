...
print(f"""
  ...
  - And the tree-level + one-loop results give all 72 predictions.
...
checklist = [
    ...
    ("4. Reproduce established physics",
     "DARK GREEN",
     "72 predictions, all Theorem, 0 gaps"),
    ...
    ("8. Predictivity and falsifiability",
     "GREEN",
     "8 kill-shots, 44 precise predictions, 119 verification scripts"),
